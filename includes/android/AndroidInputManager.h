...
//http://code.google.com/p/gamekit/source/browse/trunk/Dependencies/Source/OIS/
...
public:
        ...
        void injectTouch(int action, float x, float y, int pid = 0, float pressure = 1.0f);
...
public:
        ...
        void injectTouch(int action, float x, float y, int id=0.0f, float p=1.0f) { if (mTouch) mTouch->injectTouch(action, x, y, id, p); }
